...
| `tabStyles`       | ```javascript { tab?: Object, badgeBubble?: Object, badgeText?: Object }``` | ```javascript { tab: {}, badgeBubble: {}, badgeText: {} }``` | Set styles for every tab and bubble |
